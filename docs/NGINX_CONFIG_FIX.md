...
The deployment workflows (dev, UAT, and production) were using heredoc syntax incorrectly to generate nginx configuration files.
...
This meant even if nginx config was invalid, the deployment would continue, leading to silent failures.
