...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "message",
                    models.TextField(
                        blank=True, help_text="Optional message from inviter"
                    ),
                ),
                (
                    "accepted_by",
        ...
        migrations.AddIndex(
            model_name="tenantdomain",
            index=models.Index(
                fields=["tenant", "is_primary"], name="td_tenant_primary_idx"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="tenantinvitation",
            index=models.Index(
                fields=["email", "status"], name="tenants_inv_email_74dee3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="tenantinvitation",
            index=models.Index(
                fields=["tenant", "status"], name="tenants_inv_tenant__acc54c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="tenantinvitation",
            index=models.Index(
                fields=["expires_at"], name="tenants_inv_expires_181628_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tenant", "is_active"], name="tenants_ten_tenant__78b8df_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="tenantuser",
            index=models.Index(
                fields=["user", "is_active"], name="tenants_ten_user_id_d07440_idx"
            ),
        ),
