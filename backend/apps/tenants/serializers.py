...
class TenantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Tenant
        fields = [
            'id', 'name', 'slug', 'domain', 'contact_email', 'contact_phone',
            'is_active', 'is_trial', 'trial_ends_at', 'user_count',
            'is_trial_expired', 'created_at', 'updated_at', 'settings'
        ]
...
class TenantCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_trial', 'trial_ends_at', 'settings',
...
class TenantUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'username', 'email', 'first_name', 'last_name', 'tenant_name',
