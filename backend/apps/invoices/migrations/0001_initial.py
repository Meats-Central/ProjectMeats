        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "our_sales_order_num",
                    models.CharField(
                        blank=True, help_text="Our sales order number", max_length=100
                    ),
                ),
                (
                    "delivery_po_num",
                    models.CharField(
                        blank=True, help_text="Delivery PO number", max_length=100
                    ),
                ),
                (
                ...
                (
                    "type_of_protein",
                    models.CharField(
                        blank=True, help_text="Type of protein", max_length=100
                    ),
                ),
                (
                    "description_of_product_item",
                    models.TextField(
                        blank=True, help_text="Description of product item"
                    ),
                ),
                (
                    "quantity",
